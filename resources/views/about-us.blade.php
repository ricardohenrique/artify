...
<section class="py-5 bg-white">
    <div class="container">
        <h1 class="display-5 fw-bold mb-4 text-center">🎨 Welcome to Artify</h1>
        ...
        <div class="row mb-5">
            <div class="col-md-6">
                <h2 class="fw-semibold">🖌️ For Artists</h2>
                <ul class="mt-3">
            ...
            <div class="col-md-6">
                <h2 class="fw-semibold">🛍️ For Buyers</h2>
                <ul class="mt-3">
        ...
        <!-- Safety -->
        <div class="mb-5">
            <h2 class="fw-semibold">🔒 Safety and Trust</h2>
            <ul class="mt-3">
        ...
        <div class="text-center mt-5">
            <p class="lead">Join us at Artify and be part of a community where art comes to life.</p>
        </div>
    </div>
</section>
@endsection