            ...
            <div class="col-md-9">
                <div class="bg-white rounded shadow-sm p-4 mb-4">
                    <div class="text-center mb-5">
                        <a href="{{ route('painting.create') }}" class="btn btn-primary btn-lg px-5 py-3 fs-5">
                            + Add New Painting
                        </a>
                    </div>
                            ...
                            <div class="row g-4">
                                @foreach($paintings as $painting)
                                    <div class="col-md-4 col-sm-6">
                                        <a href="{{ route('painting.edit-details', $painting->id) }}" class="text-decoration-none text-dark">
                        ...
                        @else
                            <div class="row g-4">
                                @foreach($drafts as $draft)
                                    <div class="col-md-4 col-sm-6">
                                        <a href="{{ route('painting.edit-details', $draft->id) }}" class="text-decoration-none text-dark">
